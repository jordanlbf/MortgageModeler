...
from app.routers import amortisation, tax, purchase_costs, ongoing_costs, rent_paid, rent_received
...
app.include_router(rent_paid.router, prefix="/api")
app.include_router(rent_received.router, prefix="/api")
