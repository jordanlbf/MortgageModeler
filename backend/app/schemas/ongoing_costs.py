...
class OngoingPropertyCostRequest(BaseModel):
    ...
    vacancy_weeks: int = Field(default=2, ge=0, le=52, description="Expected number of weeks the property will be vacant per year")
    is_investment: bool = Field(default=False, description="Whether the property is an investment property")
    projection_years: int = Field(default=10, ge=1, le=50, description="Number of years to project ongoing costs for")
    annual_cost_growth_rate: float = Field(default=0.025, ge=0, le=1, description="Expected annual growth rate for ongoing costs (as a decimal, e.g., 0.03 for 3%)")
    ...
    maintenance_rate: float = Field(default=0.01, ge=0, le=1, description="Annual maintenance cost as a percentage of property value (as a decimal, e.g., 0.01 for 1%)")
    management_rate: float = Field(default=0.08, ge=0, le=1, description="Annual property management fee as a percentage of rental income (as a decimal, e.g., 0.08 for 8%)")
