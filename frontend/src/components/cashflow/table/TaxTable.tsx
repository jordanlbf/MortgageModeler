        ...
        <table className="border-collapse tabular-nums text-[13px] leading-[1.4] whitespace-nowrap w-full min-w-full table-auto">
          ...
          <tbody>
            {yearData.map((y, i) => {
              ...
              return (
                <tr key={y.year} className={`${getRowClass(y.year, isMilestone)} ${isCollapsed ? "h-14" : ""}`} {...getRowHandlers(y.year, isMilestone)}>
                  ...
                  {dedExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{formatDollarsSigned(Math.round(y.ongoingCosts))}</td>}
                  {dedExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{formatDollarsSigned(Math.round(y.interestPortion))}</td>}
                  {dedExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{formatDollarsSigned(Math.round(depreciation))}</td>}
                  ...
                  {/* Tax detail cells */}
                  {taxExpanded && <td className="h-[52px] box-border pl-6 pr-3 text-right align-middle border-b border-b-white/[0.04] out-zone text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{formatDollarsSigned(Math.round(totalIncome))}</td>}
                  {taxExpanded && <td className={`h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] out-zone animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)] ${getValueClass(-totalDeductions, false, true)}`}>{formatDollarsSigned(Math.round(-totalDeductions))}</td>}
                  {taxExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] out-zone animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]" style={{ color: "var(--color-positive)" }}>
                    {y.taxSaved > 0 ? `+${formatDollarsSigned(Math.round(y.taxSaved))}` : "—"}
                  </td>}
                  {taxExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] out-zone text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{formatDollarsSigned(Math.round(taxableIncome))}</td>}
                  {taxExpanded && <td className="h-[52px] box-border px-3 text-right align-middle border-b border-b-white/[0.04] out-zone text-foreground animate-[col-fade-in_0.25s_cubic-bezier(0.16,1,0.3,1)]">{(bracket * 100).toFixed(bracket % 0.01 === 0 ? 0 : 1)}%</td>}
            ...
            <tr className="row-summary">
              ...
              {dedExpanded && (
                <td className="box-border px-3 text-right align-middle text-foreground font-medium text-[15px]" style={summaryBorder}>{formatDollarsSigned(Math.round(totals.holding))}</td>
              )}
              {dedExpanded && (
                <td className="box-border px-3 text-right align-middle text-foreground font-medium text-[15px]" style={summaryBorder}>{formatDollarsSigned(Math.round(totals.interest))}</td>
              )}
              {dedExpanded && (
                <td className="box-border px-3 text-right align-middle text-foreground font-medium text-[15px]" style={summaryBorder}>{formatDollarsSigned(Math.round(totals.depr))}</td>
              )}
              <td className="box-border px-3 text-right align-middle text-[15px]" style={summaryBorder}>
                <span className="font-semibold text-foreground">{formatDollarsSigned(Math.round(totals.totalDed))}</span>
              </td>
              {taxExpanded && (
                <td className="box-border pl-6 pr-3 text-right align-middle text-foreground font-medium text-[15px]" style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>{formatDollarsSigned(Math.round(totals.income))}</td>
              )}
              {taxExpanded && (
                <td className="box-border px-3 text-right align-middle text-negative font-medium text-[15px]" style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>{formatDollarsSigned(Math.round(-totals.totalDed))}</td>
              )}
              {taxExpanded && (
                <td className="box-border px-3 text-right align-middle text-positive font-medium text-[15px]" style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>{formatDollarsSigned(Math.round(totals.benefit))}</td>
              )}
              {taxExpanded && (
                <td className="box-border px-3 text-right align-middle text-faint text-[15px]" style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>—</td>
              )}
              {taxExpanded && (
                <td className="box-border px-3 text-right align-middle text-faint text-[15px]" style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>—</td>
              )}
              <td className={`box-border ${!taxExpanded ? "pl-6 pr-5" : "px-3 pr-5"} text-right align-middle text-[15px]`} style={{ ...summaryBorder, background: "var(--color-out-tint-raised)" }}>
                <span className="font-bold text-negative">{formatDollarsSigned(Math.round(-totals.tax))}</span>
              </td>
            </tr>
          </tbody>
        </table>
