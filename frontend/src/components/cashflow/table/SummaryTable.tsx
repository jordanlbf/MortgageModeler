        ...
        <table className="border-collapse tabular-nums text-xs leading-[1.4] whitespace-nowrap w-full table-auto">
          <thead>
            ...
            <tr className="h-14 border-b border-white/[0.12]">
              ...
              {isGroupExpanded("income") && isInvestment && <th className="h-14 box-border align-middle px-3 text-[11px] font-normal tracking-[0.02em] capitalize text-fg-tertiary text-right whitespace-nowrap tip animate-col-fade-in" data-tip="Year-on-Year Rent Growth">gain %</th>}
              <th className="h-14 box-border align-middle px-3 text-[11px] tracking-[0.02em] capitalize text-fg-secondary font-bold pr-5 text-right whitespace-nowrap tip" data-tip="Salary + Rent">total income</th>
            </tr>
          </thead>
          <tbody>
            {yearData.map((y, i) => {
        ...
        <table className="border-collapse tabular-nums text-xs leading-[1.4] whitespace-nowrap w-full table-auto">
          <thead>
            ...
            <tr className="h-14 border-b border-white/[0.12]">
              ...
              <th className="h-14 box-border align-middle px-3 text-[11px] tracking-[0.02em] capitalize text-fg-secondary font-bold pr-5 text-right whitespace-nowrap tip" data-tip="Holding + Repayments + Tax">total costs</th>
            </tr>
          </thead>
          <tbody>
            {yearData.map((y) => {
