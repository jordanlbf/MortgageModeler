...
const SMALL_INPUT_CLS = "flex-1 min-w-0 text-[13px] py-1.5 px-2.5 bg-transparent border border-default rounded-xl text-fg-primary font-[inherit] font-medium tabular-nums transition-[border-color] duration-200 focus:outline-none focus:border-brand/40";
